...
int main(){
    ...
    char ch;
    cout<<"Expense Category Suggestions \n";
    cout<<"Enter your choice r - g - t - e - o"<<endl;
    cin>>ch;
    ...
    switch(ch){
         case 'r':
            (rentp<40)?cout<<"You're doing well with your housing budget \n \n ":cout<<"Consider finding a more affordable place to live. \n";
            break;
         case 'g':
